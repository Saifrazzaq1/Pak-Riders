...
class postu extends StatefulWidget {
  @override
  _postuState createState() => _postuState();
}

class _postuState extends State<postu> {
  ...
  FirebaseFirestore.instance.collection('FindpostU').doc(uid).set({
